const translations = {
  zh: {
    ...
    "hero.lead": "具备商业 ERP 系统二次开发、生产问题处理和独立产品交付经验，能把需求拆成数据模型、接口、权限、任务调度、前端页面、文档与上线流程。",
    ...
    "proof.lead": "强项不是只做页面或接口，而是把客户、合同、销售、账单、报表、审批、小程序和文档沉淀串成可追踪、可复用、可持续维护的业务闭环。",
    ...
    "p1.kicker": "独立开源项目 | 2026.05 - 2026.07",
    ...
    "p2.link": "项目介绍",
    "p3.kicker": "内部 ERP 产品 | 2026.06",
    "p3.title": "蕴宇软件公司 ERP 管理系统",
    "p3.desc": "面向小型软件团队与独立工作室设计的内部管理系统，目标是把获客、客户、合同、销售、项目、任务、绩效、知识库和收支管理流程系统化。",
    ...
    "p5.kicker": "全栈独立开发 | 2026.08",
    "p5.title": "生鲜商城小程序系统",
    "p5.desc": "面向生鲜零售场景的全栈电商系统，独立搭建「微信小程序 + PC 运营后台 + 后端」三端协同架构，6 天内完成需求到部署文档的全流程，覆盖商品、库存、购物车、订单、支付、退款、用户与运营后台等核心模块，提供约 84 个后端接口，实现从浏览下单到支付退款的完整交易闭环。",
    "p5.b1": "自研订单状态机（非连续状态值 + 原子判断），保证状态流转幂等，杜绝重复发货与状态错乱。",
    "p5.b2": "微信支付 V3 全链路对接 + 完整退款体系（仅退款 / 部分退款 / 原路退回），基于 Redisson 分布式锁防并发重复退款。",
    "p5.b3": "密钥 AES 密文存储、演示开关模拟真实支付链路，沉淀数据库修复、运维部署、商用运维等系列文档。",
    "p5.link": "开发文档总索引",
    "tag.wechat": "微信小程序",
    ...
    "timeline.title": "经历脉络",
    "timeline.lead": "以商业 ERP 生产系统经验为主线，持续沉淀内部应用、数据模型、接口集成、问题定位和交付文档能力。",
    "timeline.t1": "商业 ERP 生产系统开发",
    "timeline.d1": "参与百万级商业管理 ERP 二次开发与维护，覆盖客户、合同、账单、报表、审批和小程序集成。",
    "timeline.t2": "独立产品与全栈交付",
    "timeline.d2": "将 ERP 经验沉淀到点餐系统、论坛小程序和内部 ERP 产品，保留截图、源码、文档和上线证据。",
    "timeline.t3": "Corp IT / Oracle ERP 方向准备",
    "timeline.d3": "围绕 SQL、报表、系统集成、L1/L2 问题处理、UAT、变更记录与文档沉淀补齐岗位关键词。",
    ...
    "alt.freshDashboard": "生鲜商城运营后台首页",
    "alt.freshMiniHome": "生鲜商城小程序首页",
    "alt.freshProduct": "生鲜商城商品详情页"
  },
  en: {
    ...
    "hero.lead": "Enterprise application developer with hands-on commercial ERP secondary development, production issue handling, and independent product delivery experience. Strong in turning requirements into data models, APIs, permissions, scheduled jobs, front-end pages, documentation, and release workflows.",
    ...
    "proof.lead": "My strength is not only building pages or APIs. I connect customers, contracts, sales, billing, reports, approvals, mini-programs, and documentation into traceable, reusable, and maintainable business workflows.",
    ...
    "p5.kicker": "Full-stack independent development | Aug 2026",
    "p5.title": "Fresh Mall Mini-Program System",
    "p5.desc": "A full-stack e-commerce system for the fresh-produce retail scenario, with an independently built three-tier architecture of WeChat mini-program + PC ops admin + backend. Completed the full flow from requirements to deployment docs in 6 days, covering goods, inventory, cart, orders, payment, refunds, users, and the ops backend, exposing about 84 backend APIs and delivering a complete transaction loop from browsing to paid refunds.",
    "p5.b1": "Self-built order state machine (non-sequential status values + atomic checks) guarantees idempotent transitions and prevents duplicate shipping or status corruption.",
    "p5.b2": "Full WeChat Pay V3 integration plus a complete refund system (refund-only / partial / original-route), with Redisson distributed locks preventing concurrent duplicate refunds.",
    "p5.b3": "AES-encrypted secrets and a demo switch simulating the real payment flow, with a series of docs on DB repair, ops deployment, and commercial operations.",
    "p5.link": "Dev Docs Index",
    ...
    "timeline.lead": "The core thread is production ERP experience, internal applications, data modeling, system integration, troubleshooting, and delivery documentation.",
    "timeline.t1": "Commercial ERP production system development",
    "timeline.d1": "Participated in the secondary development and maintenance of a large commercial ERP platform covering customers, contracts, billing, reports, approvals, and mini-program integrations.",
    "timeline.t2": "Independent product and full-stack delivery",
    "timeline.d2": "Turned ERP experience into an ordering system, forum mini-program, and internal ERP product with screenshots, source code, documentation, and launch evidence.",
    "timeline.t3": "Corp IT / Oracle ERP readiness",
    "timeline.d3": "Strengthening SQL, reporting, system integration, L1/L2 troubleshooting, UAT, change records, and documentation for enterprise IT roles.",
    "contact.eyebrow": "Contact",
    ...
    "alt.freshDashboard": "Fresh mall admin dashboard home",
    "alt.freshMiniHome": "Fresh mall mini-program home",
    "alt.freshProduct": "Fresh mall product detail",
  }
};
