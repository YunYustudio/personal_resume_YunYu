...
export const ui: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "hero.lead":
      "具备 1 年商业 ERP 二次开发实战 + 独立产品全栈交付经验：在百万级生产系统上累计解决 237 条生产任务；离职后以「外包 + 开源自研」模式独立交付 7 个上线级系统（电商 / 论坛 / 跑腿 / ERP / 点餐 / VR 展厅）。擅长把复杂需求拆成数据模型、接口、权限、调度、前端页面与上线流程，并在 2 核 4GB 低配服务器上完成性能工程。",
    "hero.k1": "个独立交付产品",
    "hero.k2": "个后端接口",
    "hero.k3": "条禅道生产任务",
    "hero.k4": "字技术文档",
    "hero.techsAria": "技能关键词",
    "hero.tech1": "Java 21",
    "hero.tech2": "Spring Boot 3.x",
    "hero.tech3": "Vue3",
    "hero.tech4": "uni-app",
    "hero.tech5": "微信小程序",
    "hero.tech6": "微信支付 V3",
    "hero.tech7": "MySQL & Redis",
    "hero.tech8": "Docker & Linux",
  ...
  en: {
    ...
    "hero.lead":
      "Enterprise developer with 1+ year of commercial ERP secondary development plus independent full-stack delivery: 237 production tasks resolved on a million-level system, and 7 launch-ready systems independently delivered (e-commerce / forum / errand / ERP / ordering / VR showroom) under an outsourcing + open-source model. I turn complex requirements into data models, APIs, permissions, scheduling, front-end pages, and go-live flows, with performance engineering on 2-core 4GB servers.",
    "hero.k1": "Independent products delivered",
    "hero.k2": "Backend APIs",
    "hero.k3": "ZenTao production tasks",
    "hero.k4": "chars of technical docs",
    "hero.techsAria": "Tech keywords",
    "hero.tech1": "Java 21",
    "hero.tech2": "Spring Boot 3.x",
    "hero.tech3": "Vue3",
    "hero.tech4": "uni-app",
    "hero.tech5": "WeChat Mini Program",
    "hero.tech6": "WeChat Pay V3",
    "hero.tech7": "MySQL & Redis",
    "hero.tech8": "Docker & Linux",
